...
class AddContact():
    ...
    def add_contact(self):
        ...
        self.driver.find_element(By.XPATH, Contact_Locators.company_name_field).send_keys("7One Piece")
        ...
        self.driver.find_element(By.XPATH, Contact_Locators.user_name_field).send_keys("KishoreSiva7")
